...
> A digital swamp of unfiltered, eclectic thoughts—random, niche-free, and chaotic.

Welcome to **Mindmire** (MY-er), a static blog built on the tailwind-nextjs-starter-blog template, customized with a swampy, organic aesthetic for sharing unstructured thoughts and random ideas.

## 🌿 About Mindmire

Mindmire is designed to be:

- **Unfiltered**: No specific niche or topic constraints
- **Organic**: Swampy, natural design that feels lived-in
- **Authentic**: Raw thoughts and half-formed ideas welcome
- **Chaotic**: Random content types and unpredictable posting

## ✨ Features

- **Swampy Design Theme**: Deep greens, murky browns, and organic styling
- **Markdown/MDX Support**: Full content management via filesystem
- **Tag-based Navigation**: Explore content through the "Mire Map"
- **Responsive Design**: Looks great on all devices
- **Dark/Light Mode**: Automatic theme switching
- **Series Support**: Organize related posts in subdirectories
- **Social Sharing**: Built-in sharing buttons for posts
- **Search Functionality**: Find content across the mire
- **Analytics Ready**: Google Analytics and Umami support
...
Create subdirectories in `/data/blog/` for related posts:
...
The theme uses custom CSS variables defined in `/css/tailwind.css`:

- **Primary**: Deep forest greens
- **Accent**: Murky browns and amber
- **Background**: Subtle swamp gradients
- **Cards**: Semi-transparent with green borders

### Custom Components

- `.mire-card`: Standard content cards
- `.mire-card-featured`: Highlighted cards
- `.mire-button`: Primary action buttons
- `.mire-tag`: Content tags
- `.wavy-divider`: Organic section dividers

### Fonts

- **Display** (Headings): Caveat (Google Fonts)
- **Body**: Open Sans (Google Fonts)
- **Serif** (Accents): Lora (Google Fonts)
...
NEXT_UMAMI_ID=xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx

# GitHub Integration
NEXT_PUBLIC_GITHUB_USER=yourusername
NEXT_PUBLIC_GITHUB_REPO=yourrepo

# Comments (Giscus)
NEXT_PUBLIC_GISCUS_REPO=yourusername/yourrepo
NEXT_PUBLIC_GISCUS_REPOSITORY_ID=R_XXXXXXXXXX
...
Set up your domain (e.g., mindmire.com):

1. Configure DNS records
2. Update `siteUrl` in `siteMetadata.js`
...
- **Styling**: Update `/css/tailwind.css`
- **Content types**: Extend MDX processing

## 📈 Analytics & SEO

- **Google Analytics**: Configure with `NEXT_PUBLIC_GA_ID`
- **Umami**: Alternative analytics with `NEXT_UMAMI_ID`
...
- **Live Site**: [mindmire.com](https://mindmire.com)
- **Twitter**: [@Mindmire](https://twitter.com/Mindmire)
- **Source**: [GitHub](https://github.com/khokonm/mindmire)

---

_Built with the swampy vibes of Next.js and Tailwind CSS_
